...
**Problem**: [Slam Shuffle](https://adventofcode.com/2019/day/22)

**Stars**: ⭐️⭐️ (with caveats)

**Code**: [day22.ex](lib/aoc/day22.ex)

**Tests**: [day22_test.exs](test/aoc/day22_test.exs)

**Hex Libraries**: -

**Techniques**: [Enum/Mapping](https://hexdocs.pm/elixir/Enum.html#content), Shuffle, Modulo Arithmetic

Fuh. On the upside (?I guess?) we've discovered a limit of the Erlang `:crypto` module: on sufficiently large numbers functions will silently return incorrect values:

```elixir
iex> :crypto.mod_pow(-, 101741582076661, 119315717514047) |> :binary.decode_unsigned()
29522037673037
```

The result _should_ be `87505940779834`, which can be verified in Python:

```python
>>> pow(-, 101741582076661, 119315717514047)
87505940779834
```
